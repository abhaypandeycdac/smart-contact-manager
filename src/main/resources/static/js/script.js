      ...
      console.log(response);
       if (response.status == "created") {
        ...
        let options = {
          ...
          notes: {
            address: "Learn how to integrate rajorpay api",
          },
          theme: {
            color: "#3399cc",
          },
 ...
 function updatePaymentOnServer(payment_id,order_id,status)
{
    ...
    success: function (response) {
		...
		{
		 swal("Failed !!", " your payment is done from your side but havent geta  another side!!", "error");	
		},
	});
}
